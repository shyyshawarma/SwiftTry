...
def log_validation(
    ...
    for test_case in zip(video_paths, masked_video_paths, mask_video_paths, pose_video_paths):
        ...
        for ref_cloth_path in ref_cloth_image_paths:
            ...
            predicted_flows_vis = flow_to_image(predicted_flows)
            predicted_flows_vis = predicted_flows_vis / 255.
...
def main(cfg):
    ...
    flow_guider = FlowEncoder(guidance_embedding_channels=320, guidance_input_channels=2).to(device='cuda')
