...
from src.pipelines.pipeline_tryon_video_random_shiftcache_attention_random import TryOnVideoPipeline
...
if __name__ == '__main__':
    ...
    parser.add_argument("--test_pairs", type=str, default="/root/dataset/TikTokDress/test_unpaired_new.txt")
    # parser.add_argument("--save_dir", type=str, default="./output_result/test_tiktok_ootmask_paired_shiftcaching_random_repaint")
    parser.add_argument("--save_dir", type=str, default="./_output_result/test_tiktok_new_mask_shiftcaching_random_unpaired")
    ...
    for video_id, cloth_id in tqdm(test_pairs):
        ...
        controller.tryon_video(
            ...
            masked_video_path=join(args.data_dir, "videos_all_normalized_masked", f"{video_id}"), # videos_all_normalized_masked
            mask_video_path=join(args.data_dir, "videos_all_normalized_mask", f"{video_id}"), # videos_all_normalized_mask
