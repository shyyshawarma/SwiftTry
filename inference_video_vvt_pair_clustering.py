...
if __name__ == '__main__':
    ...
    parser.add_argument("--test_pairs", type=str, default="/root/dataset/VVT_video/train_pairs.txt")

    parser.add_argument("--save_dir", type=str, default="./output_result/token_vvt_clustering")
