...
from src.pipelines.pipeline_tryon_video_random_flatten import TryOnVideoPipeline
...
if __name__ == '__main__':
    ...
    parser.add_argument("--config", type=str, default="./configs/prompts/tryon_video_flow_attn.yaml")
    ...
    save_dir = "./output_result/test_vvt_vvt_512_paired(oot)_flow_attn_w=3"
    # read txt file
