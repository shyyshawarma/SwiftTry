...
if __name__ == '__main__':
    ...
    parser.add_argument("--save_dir", type=str, default="./output_result/test_tiktok_finalSAM2mask_unpaired_average_4_repaint")
    ...
    test_pairs = test_pairs[le:]
    
    for video_id, cloth_id in tqdm(test_pairs):
        cloth_path = join(args.data_dir, "garments_normalized_newest", cloth_id)
