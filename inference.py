...
from src.pipelines.pipeline_tryon_video_random_debug import TryOnVideoPipeline
...
class TryOnController:
    ...
    def tryon_video(
        ...
        videos, overlapped_video, nonoverlapped_video = self.pipeline(
            ref_cloth_image,
...
if __name__ == '__main__':
    ...
    parser.add_argument("--test_pairs", type=str, default="/root/dataset/VVT_video/test_pairs_difficult.txt")
    args = parser.parse_args()
    controller = TryOnController(args.config)
    save_dir = "./output_result/test_debug_difficult"
    # read txt file
