...
if __name__ == '__main__':
    ...
    parser.add_argument("--test_pairs", type=str, default="/root/dataset/TikTokDress/test_paired_new.txt")
    parser.add_argument("--save_dir", type=str, default="./output_result/test_tiktok_new_SAM2mask_unpaired_averaging_C4_repaint")
    parser.add_argument("--overlap_value", type=int, default=4)
    ...
    for video_id, cloth_id in tqdm(test_pairs):
        ...
        controller.tryon_video(
            ...
            masked_video_path=join(args.data_dir, "videos_all_normalized_masked_new", f"{video_id}"), # videos_all_normalized_masked
            mask_video_path=join(args.data_dir, "videos_all_normalized_mask_new", f"{video_id}"), # videos_all_normalized_mask
