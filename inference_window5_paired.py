...
if __name__ == '__main__':
    ...
    parser.add_argument("--config", type=str, default="./configs/prompts/tryon_video_window_w5.yaml")
    ...
    save_dir = "./output_result/test_vvt_vvt_512_paired(oot)_window_attn_w=5_correct"
    # read txt file
