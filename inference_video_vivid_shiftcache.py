...
if __name__ == '__main__':
    ...
    parser.add_argument("--test_pairs", type=str, default="/root/dataset/ViViD/ViViD/upper_body/new_test_pairs_shuffle.txt")

    args = parser.parse_args()
    controller = TryOnController(args.config)
    save_dir = "./_output_result/demo_vivid_hung_shiftonly/"
    # read txt file
    ...
    test_pairs_len = len(test_pairs) // 2
    test_pairs = test_pairs[test_pairs_len:]
