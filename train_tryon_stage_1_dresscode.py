...
def log_validation(
    ...
    ref_cloth_image_paths = [
        "./configs/inference/ref_cloth_images/049114_1.jpg",
        "./configs/inference/ref_cloth_images/048724_1.jpg",
        "./configs/inference/ref_cloth_images/048433_1.jpg",
    ]
    pose_image_paths = [
        "./configs/inference/poses/048392_0.png",
        "./configs/inference/poses/048393_0.png",
        "./configs/inference/poses/048408_0.png",
    ]
    masked_image_paths = [
        "./configs/inference/masked_images/048392_0.png",
        "./configs/inference/masked_images/048393_0.png",
        "./configs/inference/masked_images/048408_0.png",
    ]
    mask_paths = [
        "./configs/inference/masks/048392_0_mask.png",
        "./configs/inference/masks/048393_0_mask.png",
        "./configs/inference/masks/048408_0_mask.png",
    ]
    image_paths = [
        "./configs/inference/images/048392_0.jpg",
        "./configs/inference/images/048393_0.jpg",
        "./configs/inference/images/048408_0.jpg",
    ]
    ...
    for ref_cloth_image_path in ref_cloth_image_paths:
        for pose, masked, mask, orig_image in zip(pose_image_paths, masked_image_paths, mask_paths, image_paths):
            pose_name = pose.split("/")[-1].replace(".png", "")
            ref_name = ref_cloth_image_path.split("/")[-1].replace(".png", "")
...
def main(cfg):
    ...
    train_dataset = DressCodeDataset(
        dataroot_path=cfg.data.meta_paths,
        phase='train',
        order='paired',
        category=['upper_body'],
        size=(cfg.data.train_height, cfg.data.train_width)
    )
    ...
    for epoch in range(first_epoch, num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(net):
                ...
                masked_images = batch["m"].to(weight_dtype)
                masks = batch["mask"].to(weight_dtype)
                ref_cloth_images = batch["cloth"].to(weight_dtype)
                pose_images = batch["skeleton"].to(weight_dtype)
