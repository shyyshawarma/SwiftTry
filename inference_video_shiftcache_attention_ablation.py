...
from src.pipelines.pipeline_tryon_video_random_shiftcache_attention import TryOnVideoPipeline
...
if __name__ == '__main__':
    ...
    parser.add_argument("--save_dir", type=str, default="./output_result/test_vvt_difficult_pair")
    parser.add_argument("--overlap_value", type=int, default=4)
    parser.add_argument("--drop_interval", type=int, default=1)
