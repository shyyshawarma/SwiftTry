...
class TryOnController:
    ...
    def tryon_video(
        ...
        if self.pipeline is None:
            ...
            cluster_merge.apply_patch(denoising_unet, {}) # Custom here
...
if __name__ == '__main__':
    ...
    parser.add_argument("--test_pairs", type=str, default="/root/dataset/ViViD/ViViD/upper_body/train_pairs.txt")
    args = parser.parse_args()
    controller = TryOnController(args.config)
    save_dir = "./output_result/token_vivid_clustering_timestep"
    # read txt file
