...
class UNet3DConditionOutput(BaseOutput):
    ...
    intermediate_features: List[torch.FloatTensor]
        ...
        **kwargs
        ...
        for downsample_block in self.down_blocks:
            if (
                ...
                sample, res_samples, saved_features = downsample_block(
                ...
                intermediate_features.extend(saved_features)
            else:
        ...
        # mid
        sample, saved_features = self.mid_block(
            sample,
            emb,
            encoder_hidden_states=encoder_hidden_states,
            attention_mask=attention_mask,
        ...
        for i, upsample_block in enumerate(self.up_blocks):
            ...
            if (
                ...
                sample, saved_features = upsample_block(
                    hidden_states=sample,
                    temb=emb,
        ...
        return UNet3DConditionOutput(sample=sample, intermediate_features=intermediate_features)
