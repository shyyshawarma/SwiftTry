...
from src.utils.utils_flatten import sample_trajectories, create_indices_trajectories
...
class TryOnVideoPipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        trajs_all = []
        for context in tqdm(global_context):
            trajs = create_indices_trajectories(height, width, len(context[0]), device='cuda')
            inject_step = 0
            old_qk = 0
