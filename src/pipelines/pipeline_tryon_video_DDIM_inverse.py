...
class TryOnVideoPipeline(DiffusionPipeline):
    ...
    def DDIM_inversion(
        ...
        **kwargs,
        ...
        entered = False
        f = image_latents.shape[2]
        # image_latents = rearrange(image_latents, "b c f h w -> (b f) c h w")

        latents = image_latents.detach().clone()
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                if t > skip_t:
                    ...
                    if not entered:
                        print(
                            f"DDIM Inversion: with i = {i}, t = {t}, latent = {latents.shape}, device = {latents.device}, type = {latents.dtype}")
                        entered = True
                ...
                for context in global_context:
                    ...
                    # print(latent_model_input.shape, masked_image_latents_input.shape, masks_input.shape)
    ...
    def __call__(
        ...
        **kwargs,
        ...
        self.inverse_scheduler.set_timesteps(num_inference_steps, device=device) # 60%
        ...
        inversed_image_latents = self.DDIM_inversion(
            ref_cloth_image_latents,
            image_latents,
            masked_image_latents,
            masks,
        ...
        latents = inversed_image_latents
