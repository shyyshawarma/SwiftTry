...
class VersatileAttention(Attention):
    def __init__(
        ...
        **kwargs,
        ...
        self.set_processor(FlowGuidedAttnProcessor())
    ...
    def set_use_memory_efficient_attention_xformers(
        ...
        if use_memory_efficient_attention_xformers:
            ...
            # )
            processor = FlowGuidedAttnProcessor()
        else:
            processor = FlowGuidedAttnProcessor()
...
class FlowGuidedAttnProcessor(AttnProcessor):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        #     query_tempo, key_tempo, value_tempo, attn_bias=attention_mask
        # )
        ...
        hidden_states = rearrange(out,'(b f) k (h w) d -> (b h w) f (k d)', f=video_length, h=height, w=width)
