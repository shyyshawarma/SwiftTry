...
class VanillaTemporalModule(nn.Module):
    def __init__(
        ...
        self.motion_combine_type = motion_combine_type
        if zero_initialize:
    ...
    def forward(
        ...
        **kwargs
        ...
        # flows = kwargs.get('flow_fea')
        assert flows is not None, "Should input flow"
        hidden_states = input_tensor
        """ 
            hidden_states: BCFHW: feature spatial layers from Diffusion
            

        """
        if flows is not None and flows.shape == hidden_states.shape: # Bug is here?
            hidden_states = input_tensor + flows
