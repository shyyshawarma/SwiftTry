    ...
    def forward(
        ...
        **kwargs
        ...
        for attn, resnet, motion_module in zip(
            ...
            hidden_states = (
                motion_module(
                    hidden_states, temb, encoder_hidden_states=encoder_hidden_states, **kwargs
                )
...
class DownBlock3D(nn.Module):
    ...
    def forward(self, hidden_states, temb=None, encoder_hidden_states=None, exist_module_idx: Optional[int] = None, **kwargs):
        output_states = ()
    ...
    def forward(
        ...
        **kwargs
        ...
        for i, (resnet, attn, motion_module) in enumerate(
            ...
            if enter_module_idx is not None and i < enter_module_idx:
                continue
