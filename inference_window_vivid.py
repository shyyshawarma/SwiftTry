...
if __name__ == '__main__':
    ...
    parser.add_argument("--config", type=str, default="./configs/prompts/tryon_video_window.yaml")
    parser.add_argument("--data_dir", type=str, default="/root/dataset/ViViD/ViViD/upper_body")
    parser.add_argument("--test_pairs", type=str, default="/root/dataset/ViViD/ViViD/upper_body/test_pairs_difficult.txt")
    args = parser.parse_args()
    controller = TryOnController(args.config)
    save_dir = "./output_result/test_vivid_pairs_window_w3_difficult"
    # read txt file
