...
if __name__ == '__main__':
    ...
    parser.add_argument("--test_pairs", type=str, default="/root/dataset/TikTokDress/test_paired.txt")
    args = parser.parse_args()
    controller = TryOnController(args.config)
    save_dir = "./output_result/test_tiktokdress_tiktokdress_flow_512_paired(oot)"
    # read txt file
