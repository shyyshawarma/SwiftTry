...
from src.pipelines.pipeline_tryon_video_random_shiftcacheplus_attention_random import TryOnVideoPipeline
...
if __name__ == '__main__':
    ...
    parser.add_argument("--save_dir", type=str, default="./output_result/test_tiktok_shiftcacheplus_nearby_drop3_s5")
